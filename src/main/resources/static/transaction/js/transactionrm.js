...
function fnDisplayTransactionList(dataList) {
    ...
    if (dataList != undefined && ((dataList.length && dataList[0].fault) || dataList.fault)) {
        ...
        str += " <table><tr><th>Sel<th>Transaction Id<th>Book Id<th>Book Title<th>Issue Date<th>Returned</th></tr>";
...
function setRow(dataItem, dataMode, counter) {
    ...
    strRow += "onclick='selClick(this.value," + dataMode +")' class='selectRow'/> <td>" + dataItem.transactionId;
    strRow += "<td>" + dataItem.book.bookId + "<td>" + dataItem.book.bookInfo.title;
    strRow += "<td>" + dataItem.issueDate.slice(0,10) + "<td>" + dataItem.returned + "</td></tr>";
...
The book info of the book is also displayed in a separate sub sectiony
*/
function selClick(value, mode) {
    ...
    strDtl += "<table><tr><th width=30%>Transaction Id<td>" + data.transactionId;
    strDtl += "<tr><th>User Id <td>" + data.user.userId + "<tr><th>Book Id <td>" + data.book.bookId;
    strDtl += "<tr><th>Issue Date <td>" + data.issueDate.slice(0,10);
    strDtl += "<tr><th>Return Date <td>" + data.returnDate.slice(0,10);
    ...
    strAddr += "<tr><td>" + data.user.address.doorNumber + "<td>" + data.user.address.line1;
    strAddr += "<td>" + data.user.address.line2 + "<td>" + data.user.address.city;
    strAddr += "<td>" + data.user.address.postcode + "</table>";

    let strBook = "<h3>&nbsp;&nbsp;&#x25A0 &nbsp;Book Details</h3>";
    strBook += "<table><tr><th width=30%>Book Id<td>" + data.book.bookId + "<tr><th>Shelf Reference";
    strBook += "<td>" + data.book.shelfReference + "<tr><th>Location <td>" + data.book.location;
    ...
    strBookInfo += "<th>Isbn<th>Publisher<th>Price<th>totalQuantity";
    strBookInfo += "<tr><td>" + data.book.bookInfo.bookInfoId + "<td>" + data.book.bookInfo.title;
    strBookInfo += "<td>" + data.book.bookInfo.author + "<td>" + data.book.bookInfo.genre;
    strBookInfo += "<td>" + data.book.bookInfo.category + "<td>" + data.book.bookInfo.isbn;
