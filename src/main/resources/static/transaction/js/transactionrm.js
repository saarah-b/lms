...
async function fnSearchTransaction() {
    ...
    let apiUrl = server + apiContext + 'all/user/' + document.getElementById('txtUserId').innerText;
    let payload = "";
...
function fnDisplayTransactionList(dataList) {
    ...
    if (dataList != undefined && ((dataList.length && dataList[0].fault) || dataList.fault)) {
        ...
        str += " <table><tr><th>Sel<th>Transaction Id<th>Book Id<th>Issue Date<th>Returned</th></tr>";
