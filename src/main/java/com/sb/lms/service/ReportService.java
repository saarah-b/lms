...
public class ReportService {
    ...
    */
    ...
    public Report addReportForReportInfo(Integer reportInfoId) {
        ...
        try {
            contentDB = jdbcCall(reportInfoId);
    ...
    public String jdbcCall(Integer reportInfoId) throws Exception {
        ...
        String sqlStatement = resultSet.getString("sql_statement"); // Retrieve name from db
        pst = con.prepareStatement(sqlStatement);

        // Execute the query on the DB
        resultSet = pst.executeQuery(); // Execute query
        ...
        StringBuilder sb = new StringBuilder("<table border=1><tr><th>");
